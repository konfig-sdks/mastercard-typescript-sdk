...
import { AnalyticsReportData } from './analytics-report-data';
import { ReportCustomField } from './report-custom-field';

/**
 * 
 * @export
 * @interface AnalyticsReportConstraintsOut
 */
export interface AnalyticsReportConstraintsOut {
    /**
     * 
     * @type {AnalyticsReportData}
     * @memberof AnalyticsReportConstraintsOut
     */
