...
/**
 * This class provides a wrapper for network errors when making requests to Open Banking
 */
export class MastercardError extends Error {
  /**
   * The response body
   */
